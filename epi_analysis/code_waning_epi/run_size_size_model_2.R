...
size_size_model_2_h3_othersubtype <- stan(
  file = "~/flu_waning/size_epi_model.stan",  
  data = d,    
  chains = 4,             
  warmup = 1000,          
...
size_size_model_2_h3_noseason_othersubtype <- stan(
  file = "~/flu_waning/size_epi_noseason.stan",  
  data = d,    
  chains = 4,             
  warmup = 1000,          
...
size_size_model_2_h1pdm_othersubtype <- stan(
  file = "~/flu_waning/size_epi_model.stan",  
  data = d,    
  chains = 4,             
  warmup = 1000,          
...
size_size_model_2_h1pdm_noseason_othersubtype <- stan(
  file = "~/flu_waning/size_epi_noseason.stan",  
  data = d,    
  chains = 4,             
  warmup = 1000,          
...
b_compare_size_size_2 <- loo_compare(loo_size_size_model_2_h1pdm, loo_size_size_model_2_h1pdm_noseason)
