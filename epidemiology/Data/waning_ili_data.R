...
ili <- read.csv("Data/ili_raw.csv") # File containing raw ILI data from FluID
...
viro_data = read.csv("Data/viro_data.csv")
...
write.csv(ili_byyear,"Data/ili_data.csv",row.names=F,quote=F)
